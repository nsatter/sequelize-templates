...
function SequelizeGenerator(options) {
...
SequelizeGenerator.prototype.getData = async function () {
	var self = this;
...
SequelizeGenerator.prototype.buildTemplates = async function () {
	const self = this;
...
SequelizeGenerator.prototype.writeTemplates = async function () {
...
SequelizeGenerator.prototype.run = async function () {
	await this.getData();
